...
TRANSLATIONS: dict[LanguageCode, dict[str, str]] = {
    "pt_BR": {
        ...
        "settings.fullscreen.toggle": "Alternar: {state}",
        "settings.fullscreen.on": "ATIVADO",
        "settings.fullscreen.off": "DESATIVADO",
        "settings.fullscreen.hint": "Atalho: F11 para alternar tela cheia",
    ...
    "en_US": {
        ...
        "settings.fullscreen.toggle": "Toggle: {state}",
        "settings.fullscreen.on": "ON",
        "settings.fullscreen.off": "OFF",
        "settings.fullscreen.hint": "Shortcut: F11 to toggle fullscreen",
